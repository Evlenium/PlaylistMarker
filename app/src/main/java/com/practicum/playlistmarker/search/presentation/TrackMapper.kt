...
object TrackMapper {
    fun mapToTrackSearchItem(track: TrackDto): TrackSearchItem.Track {
    ...
    fun mapToTrackSearchWithButton(track: TrackDto): TrackSearchItem {
        return TrackSearchItem.Track(
            trackName = track.trackName,
            artistName = track.artistName,
            trackTimeMillis = track.trackTimeMillis,
    ...
    fun mapToTrackDto(track: TrackSearchItem.Track): TrackDto {
        return TrackDto(
            trackName = track.trackName,
            artistName = track.artistName,
            trackTimeMillis = track.trackTimeMillis,
